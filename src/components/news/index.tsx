...
const News = ({ data }: NewsProps): JSX.Element => (
  <div className="py-10 bg-white">
    <div className="container flex flex-col items-center">
      <div className="text-2xl font-bold uppercase text-[#316FDC]">Tin tức & Sự kiện</div>

      <div className="flex flex-col px-4 mt-8 lg:px-0">
          ...
          {data.map(article => (
            <div key={article.id} className="flex flex-col w-full">
              ...
              <div className="flex mt-auto">
                <Link href={`media-news/${article?.attributes?.slug}`}>
                  <button className="flex items-center py-2 font-bold bg-transparent border rounded-md px-9 gap-x-4 border-secondary hover:bg-primary hover:text-white">
